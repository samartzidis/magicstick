...
~~You can purchase a plug-and-play dongle package from the [magicstick-shop](https://www.ebay.co.uk/usr/magicstick-shop) on [![ebay](docs/ebay.png)](https://www.ebay.co.uk/usr/magicstick-shop).~~ Currently out of stock.

                ...
                {showPaths && (
                    <div className="card-body">
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                <h5>Device Paths</h5>
                                {selectedDevice.CommandPath && (
                                    <div className="font-monospace small mb-1">{selectedDevice.CommandPath}</div>
                                )}
                                {selectedDevice.ChargerPath && (
                                    <div className="font-monospace small mb-1">{selectedDevice.ChargerPath}</div>
                                )}
                                {selectedDevice.HidIoPath && (
                                    <div className="font-monospace small mb-1">{selectedDevice.HidIoPath}</div>
                                )}
                            </div>
                        </div>
                    </div>

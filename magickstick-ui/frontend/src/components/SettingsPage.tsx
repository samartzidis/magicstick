...
export function SettingsPage({ selectedDevice, isDeviceOpened }: SettingsPageProps) {
    const [settings, setSettings] = useState<hid.GetSettingsReply | null>(null);
    ...
    const saveSettings = async () => {
        ...
        try {
            ...
            const request = new hid.SetSettingsRequest({
            ...
            await Device.SetSettings(request);
    ...
    const handleSettingChange = (key: keyof hid.GetSettingsReply, value: boolean | number) => {
        if (!settings) return;

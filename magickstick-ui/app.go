...
// Global MagicStickDevice instance for callback application
var globalMagicStickDevice *MagicStickDevice
...
type App struct {
	...
	currentDevice *MagicStickDevice
}
...
func (a *App) SetGlobalMagicStickDevice() {
	...
	// Apply any stored callbacks to the device
...
func (a *App) setupSystemTray() {
	// Set the callback for tray icon clicks
